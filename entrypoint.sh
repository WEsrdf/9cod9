...
VMESS_WSPATH=${VMESS_WSPATH:-'/de04add9-5c68-8bab-950c-08cd5320df18-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/
de04add9-5c68-8bab-950c-08cd5320df18-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/
de04add9-5c68-8bab-950c-08cd5320df18-trojan'}
SS_WSPATH=${SS_WSPATH:-'/
de04add9-5c68-8bab-950c-08cd5320df18-shadowsocks'}
